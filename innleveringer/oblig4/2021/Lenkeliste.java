...
public class Lenkeliste<T> implements Liste<T> {
    ...
    // jobber herfra med klassen LenkelisteIterator
    // skal implementere Iterator<T>
    // dermed metodene boolean hasNext() og T next() og void remove()
    // Node klassen er en indre klasse vil denne klassen også være det

    protected class LenkelisteIterator implements Iterator<T>{
        protected Node<T> teller;

        // starter her fra forste, kan endres
        public LenkelisteIterator(){
            this.teller = forste;
        }

        @Override
        // hvis det er en neste returneres true
        // hvis ikke false
        ...
        @Override
        public T next(){
            Node<T> temp = this.teller;
            this.teller = temp.neste;
            return temp.data;
        }
    }
